...
export const API_URL = "https://channel-manager-api.vercel.app";

export interface ExtendedAxiosInstance extends AxiosInstance {
  getICalFile: (url: string) => Promise<Blob>;
}

export const createApiInstance = (): ExtendedAxiosInstance => {
  const api = axios.create({
    baseURL: API_URL,
    headers: {
      "Content-Type": "application/json",
    },
    timeout: 180000, // 3 minutes for long-running operations
...
// Export a default api instance for backward compatibility
